...
def load_models():
    ...
    try:
        ...
        lgb_model = joblib.load(max(lgb_files, key=lambda p: p.stat().st_mtime))
...
def main():
    ...
    # ====================
        ...
        if st.button("🎯 Predict Trial Risk", type="primary"):
            ...
            success_prob, risk_score = predict_single(trial_features, xgb_model, feature_names)
